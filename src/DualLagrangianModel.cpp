...
// Historical default was an author-machine absolute path; this global is
// unused (its only write call below is commented out), so the value has no
// runtime effect (see docs/historical_code_discrepancies.md, D01).
char RESULTS_1 [500] = "results/runs/SubgradientValues.txt";
